...
theta0 = linspace(-1*halfTheta0, halfTheta0, 50);
...
theta1 = linspace(-negTheta1, posTheta1, 50); %valid angles for (1,1)
onePoints = ones(1,50);
%negative one
posThetan1 = atan(lens_PosHeight/dNeg1);
negThetan1 = atan(lens_NegHeight/dNeg1);
thetaNeg1 = linspace(-posThetan1, -negThetan1, 50); %valid angles for (-1,-1)
...
theta2 = linspace(-negTheta2, posTheta2, 50); %valid angles for (1,1)
twoPoints = 2 * ones(1,50);
%negative two
posThetan2 = atan((1.8-2)/dNeg3);
negThetan2 = atan((-1.8-2)/dNeg3);
thetaNeg2 = linspace(-posThetan2, -negThetan2, 50); %valid angles for (-2,-2)
...
Shifted1theta0 = linspace(-1*NegHalfTheta0, PosHalfTheta0, 50);

%3.0/-0.6
Shift2PosHalfTheta0 = atan((lensPos_height+1.2)/d0);
Shift2NegHalfTheta0 = atan((lensNeg_height+1.2)/d0);
Shifted2theta0 = linspace(-Shift2NegHalfTheta0, Shift2PosHalfTheta0, 50);

%3.6/0
Shift3PosHalfTheta0 = atan((lensPos_height+1.8)/d0);
Shift3NegHalfTheta0 = atan((lensNeg_height+1.8)/d0);
Shifted3theta0 = linspace(-Shift3NegHalfTheta0, Shift3PosHalfTheta0, 50);
...
theta1Shifted1 = linspace(-negTheta1Shifted, posTheta1Shifted, 50);
thetaNeg1Shifted1 = linspace(-posTheta1nShifted, -negTheta1nShifted, 50);
...
theta1Shifted2 = linspace(-negTheta2Shifted, posTheta2Shifted, 50);
thetaNeg1Shifted2 = linspace(-posTheta2nShifted, -negTheta2nShifted, 50);
...
theta1Shifted3 = linspace(-negTheta3Shifted, posTheta3Shifted, 50);
thetaNeg1Shifted3 = linspace(-posTheta3nShifted, -negTheta3nShifted, 50);
...
theta2Shifted1 = linspace(-negTheta2Shifted1, posTheta2Shifted1, 50);
thetaNeg2Shifted1 = linspace(-posTheta2nShifted1, -negTheta2nShifted1, 50);
...
theta2Shifted2 = linspace(-negTheta2Shifted2, posTheta2Shifted2, 50);
thetaNeg2Shifted2 = linspace(-posTheta2nShifted2, -negTheta2nShifted2, 50); 
...
theta2Shifted3 = linspace(-negTheta2Shifted3, posTheta2Shifted3, 50);
thetaNeg2Shifted3 = linspace(-posTheta2nShifted3, -negTheta2nShifted3, 50);
